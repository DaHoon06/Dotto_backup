...
public class MemberFactory {
    ...
    public static Member createMember(String id, String nickname){
        return new Member(id,"qwe123!",nickname,"male","01012345678", emptyList(), "");
    }

    public static Member createMember(String id, String password, String nickname, String gender, String phone){
